    ...
    func getChatCompletion(initialText: String, matchedMovie: String) async throws -> String {
        var messages: [ChatQuery.ChatCompletionMessageParam] = [
            .init(
                role: .assistant,
                content: """
                You are an enthusiastic movie expert who loves recommending movies to people. You will be given two pieces of information - some context about movies and a question. Your main job is to formulate a short answer to the question using the provided context. If you are unsure and cannot find the answer, say, "Sorry, I don't know the answer." Please do not make up the answer. Always speak as if you were chatting to a friend.
                
                Example answer format you should provide: 
